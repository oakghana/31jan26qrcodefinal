...
export function LeaveNotificationsClient() {
  ...
  const roleBadge = {
    admin: { label: "Administrator", color: "bg-red-100 text-red-800 border-red-200 dark:bg-red-950 dark:text-red-200 dark:border-red-800" },
    regional_manager: { label: "Regional Manager", color: "bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-950 dark:text-blue-200 dark:border-blue-800" },
    department_head: { label: "Department Head", color: "bg-green-100 text-green-800 border-green-200 dark:bg-green-950 dark:text-green-200 dark:border-green-800" },
  }
